...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      ...
      <p className='mb-4 text-slate-700'>Nossa equipe de corretores possui vasta experiência e conhecimento no setor imobiliário e estamos comprometidos em fornecer o mais alto nível de serviço aos nossos clientes. Acreditamos que comprar ou vender um imóvel deve ser uma experiência emocionante e gratificante e estamos empenhados em tornar isso uma realidade para cada um dos nossos clientes.</p>
    </div>
  )
}
